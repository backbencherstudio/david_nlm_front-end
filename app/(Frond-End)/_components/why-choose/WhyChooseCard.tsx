    ...
    return (
        <div className='flex flex-col justify-center items-center gap-12 p-4 bg-white rounded-2xl border-[0.5px] border-borderColor hover:border-purpleOne hover:shadow-lg transition-all duration-300'>
            ...
            <div className='flex flex-col justify-center items-center gap-2.5'>
                <h3 className='text-2xl font-semibold text-blackColor leading-[130%] text-center'>{item.header}</h3>
                <p className='text-base leading-[160%] text-descriptionColor text-center'>{item.description}</p>
            </div>
        </div>
    )
}
