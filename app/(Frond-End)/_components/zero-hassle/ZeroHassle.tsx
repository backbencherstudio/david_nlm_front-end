...
const ZeroHassle = () => {
    return (
        <Container className='py-10 sm:py-30 '>
            <div className='flex flex-col lg:flex-row gap-8 lg:gap-25 items-center bg-bgColorOne rounded-2xl p-4 sm:p-10 border border-borderColor'>
                <div className='w-full lg:w-1/2 space-y-4 sm:space-y-9'>
